...
import dev.badbird.processing.asm.ClassLoaderCallTransformer;
...
public class JarLoader {
    ...
    public static synchronized void addToClassPath(URL url) {
        if (url == null) {
            throw new NullPointerException();
        }
        try {
            addToClassPath(new File(url.toURI()));
        } catch (Exception e) {
            throw new RuntimeException("error converting URL to file", e);
        }
    }
    ...
    public static void premain(String agentArgs, Instrumentation instrumentation) {
        System.out.println("JarLoader agent loaded via premain");
        instrumentation.addTransformer(new ClassLoaderCallTransformer());
    ...
    public static void agentmain(String agentArgs, Instrumentation instrumentation) {
        System.out.println("JarLoader agent loaded via agentmain");
